$(document).ready(function(){
    $.ajax({
        ...
        url : "/api/site/catalogs/product-last-offer/",
        type : 'GET',
        // data : {},
        // dataType:'json',
                ...
                for (let index = 0; index < response.length; index++) {
                    $("#last-offer").append(`
                        ...
                        <div class="md:w-2/3 flex flex-col justify-center py-5">
                            <div class="mx-auto">
                            <div class="text-zinc-800 text-lg">${response[index].title}</div>
                            ...
                            <div class="text-zinc-400 text-sm mt-1 line-through">${response[index].sale_price}</div>
                                ...
                                <div class="flex w-96 mt-5 mx-auto">
                                    ...
                                    <div class="w-1/2" id="p-options-l"></div>
                                </div>
                            
                        </div>
                        </a>
                    `);
                    for (let io = 0; io < response[index].options.length; io++) {
                        if (io%2 == 0) {
                            $("#p-options-r").html(`
                                <div class="flex gap-x-1 text-zinc-600 text-sm mt-2" >
                                    ...
                                    ${response[index].options[io].description}
                                </div>
                            `)
                        }else{
                            $("#p-options-l").html(`
...
{/* <div
                            class="clockdiv flex text-red-600 bg-red-100 px-3 py-1 rounded-md mt-6 text-center mx-auto"
                            data-date="${response[index].offer_time}"
                            >
                                <div>
